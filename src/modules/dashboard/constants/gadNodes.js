export const GAD_NODES = [
    ...
    children: [
      {
        label: '1.1 Has the project consulted women and men on the problem or issue that the intervention must solve and on the development of the solution?',
        children: [
          { label: 'No', value: 0 },
  ...
  {
  	label: '2.0 Collection of sex-disaggregated data and gender-related information',
  	children: [
      {
        label:
  ...
  },
  {
      ...
      {
        label:
          '4.2 Does the project have gender equality outputs or outcomes?',
        children: [
          { label: 'No', value: 0 },
          { label: 'Partly Yes', value: 0.5 },
          { label: 'Yes', value: 1 }
      ...
      {
      	label:
          '4.3 Does the project have gender equality outputs or outcomes?',
        children: [
          { label: 'No', value: 0 },
          { label: 'Partly Yes', value: 0.5 },
          { label: 'Yes', value: 1 }
