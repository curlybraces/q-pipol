    ...
    >
      ...
      >
        <q-stepper-navigation>
          ...
          <input-component
            label="Project Title"
            hint="Project title must match title in budget proposal"></input-component>
      ...
      <q-step
        :name="4"
        title="Three Year Rolling Infrastructure Program"
        icon="settings"
        :done="step > 4"
      >
        <q-stepper-navigation>
      ...
      <q-step
        :name="4"
        title="0-10 Point Socioeconomic Agenda"
        icon="settings"
        :done="step > 4"
      >
          <q-stepper-navigation>
