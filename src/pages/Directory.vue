  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'head', align: 'center', label: 'Head of Agency', field: 'head', sortable: true },
        { name: 'main', align: 'center', label: 'Main Focal', field: 'main', sortable: true },
        { name: 'alt1', align: 'center', label: 'Alternate Focal 1', field: 'alt1' },
        { name: 'alt2', align: 'center', label: 'Alternate Focal 2', field: 'alt2' },
        { name: 'submission', label: 'Submission', field: 'sodium' },
        { name: 'calcium', label: 'Actions', field: 'calcium', sortable: true, sort: (a, b) => parseInt(a, 10) - parseInt(b, 10) }
      ]
    }
  },
  computed: {
