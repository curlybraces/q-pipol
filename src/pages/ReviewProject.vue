    ...
    <div class="q-pa-sm">
      <div class="row q-col-gutter-sm">
        <template v-for="sdg in sustainable_development_goals">
          <div class="col-xl-1 col-lg-1 col-md-2 col-sm-2 col-xs-3" :key="sdg.id">
            <checkbox-image :image="`statics/sdg/${sdg.id}.jpg`" :value="sdgs" @input="handleInput" :val="sdg.id"></checkbox-image>
          </div>
        </template>
      </div>
    </div>
