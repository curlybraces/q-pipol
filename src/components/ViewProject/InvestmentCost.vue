<template>
  <div class="q-pa-sm q-col-gutter-y-sm">
    <q-table
      title="Fund Source"
      :data="project_investments"
      :columns="columns"
      row-key="id"
      rows-per-page="20"
    >
      <template v-slot:body="props">
        <q-tr :props="props">
          <q-td key="region" :props="props">
            {{ props.row.funding_source.label }}
            <q-popup-edit
              v-model="props.row.funding_source"
          ...
          <q-td key="investment_2017" :props="props">
            ...
            <q-popup-edit
              v-model="props.row.investment_2017"
              title="Update 2017"
              buttons
              persistent
            >
          ...
          <q-td key="investment_2018" :props="props">
            ...
            <q-popup-edit
              v-model="props.row.investment_2018"
              title="Update 2018"
              buttons
              persistent
            >
          ...
          <q-td key="investment_2019" :props="props">
            ...
            <q-popup-edit
              v-model="props.row.investment_2019"
              title="Update 2019"
              buttons
              persistent
            >
          ...
          <q-td key="investment_2020" :props="props">
            ...
            <q-popup-edit
              v-model="props.row.investment_2020"
              title="Update 2020"
              buttons
              persistent
            >
          ...
          <q-td key="investment_2021" :props="props">
            ...
            <q-popup-edit
              v-model="props.row.investment_2021"
              title="Update 2021"
              buttons
              persistent
            >
          ...
          <q-td key="investment_2022" :props="props">
            ...
            <q-popup-edit
              v-model="props.row.investment_2022"
              title="Update 2022"
              buttons
              persistent
            >
          ...
          <q-td key="investment_2023" :props="props">
            ...
            <q-popup-edit
              v-model="props.row.investment_2023"
              title="Update 2023 and beyond"
              buttons
              persistent
            >
              <q-input
          ...
          <q-td key="investment_total" :props="props">
            ...
            <q-popup-edit
              v-model="props.row.investment_total"
              title="Update total"
              buttons
              persistent
            >
      ...
      columns: [
        {
          ...
          align: "left",
          field: row => row.funding_source.label
        },
        {
