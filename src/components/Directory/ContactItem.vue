<template>
  <q-item>
    ...
    <q-item-section class="col-3">
      <q-item-label v-html="$options.filters.searchHighlight(contact.name, search)"></q-item-label>
      <q-item-label>
        {{ contact.designation }}
      </q-item-label>
    </q-item-section>
    ...
    <q-item-section class="col-2 text-center">
      <q-item-label>
        <q-btn flat icon="edit" @click="updateContactDialog=true" dense rounded color="blue"/>
        <q-btn flat icon="delete" @click="deleteContactDialog(contact.id)" dense rounded color="red"/>
      </q-item-label>
    </q-item-section>
    <q-dialog v-model="updateContactDialog" persistent>
      <q-card style="width:400px;">
        ...
        <contact-actions>
          ...
          <q-btn label="Save" icon="save" @click="updateThisContact" color="primary" />
        </contact-actions>
      </q-card>
    </q-dialog>
  </q-item>
